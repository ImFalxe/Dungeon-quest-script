--Best autofarm and best settings. their discord server : https://discord.gg/aZFny6Z6mp
...
getgenv().Settings = {
    ...
    AutoSell = {
        ...
        ItemsToKeep = {
            ...
            ["Aquatic Warrior Helmet"] = {"rare", "epic"},
            ["Aquatic Warrior Armor"] = {"rare", "epic"},
            ["Aquatic Mage Helmet"] = {"rare", "epic"},
            ["Aquatic Mage Armor"] = {"rare", "epic"},
            ["Riptide Warrior Helmet"] = {"rare", "epic"},
            ["Riptide Warrior Armor"] = {"rare", "epic"},
            ["Riptide Mage Helmet"] = {"rare", "epic"},
            ["Riptide Mage Armor"] = {"rare", "epic"},
            ...
            ["Serpent Pike"] = {"rare", "epic"},
            ["Enchanted Sea Daggers"] = {"rare", "epic"},
            ["Aquatic Spear"] = {"rare", "epic"},
            ["Ocean Pearl Staff"] = {"rare", "epic"},
...
loadstring(game:HttpGet('https://system-exodus.com/scripts/dungeonquest/Spooder.lua', true))()
